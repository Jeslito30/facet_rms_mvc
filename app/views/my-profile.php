  ...
  <body>
    ...
    <main id="mainContent" class="main-content">
      <div class="page-header">
        <h1>My Profile</h1>
        <p>Personalize your profile for easy recognization</p>
      </div>
      ...
      <div class="details-container">
        <div class="details-form-panel">
          ...
          <form id="profileForm" class="details-form">
            <div class="form-row">
              <div class="form-group">
                <label>Last Name</label>
                <input type="text" value="ACE" readonly />
              </div>
              <div class="form-group">
                <label>First Name</label>
                <input type="text" value="FACET" readonly />
              </div>
              <div class="form-group">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input
                  type="email"
                  value="jeslito.geverola@dorsu.edu.ph"
                  readonly
                />
              </div>
              <div class="form-group">
                <label>ID Number</label>
                <input type="text" value="2023-0222" readonly />
              </div>
              <div class="form-group">
                <label>Role</label>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="tel" value="09123456789" readonly />
              </div>
              <div class="form-group">
                <label>Birthdate</label>
                <input type="text" value="January 30, 2005" readonly />
              </div>
              <div class="form-group">
        ...
        <div class="details-preview-panel">
          <div class="preview-card">
            <div class="preview-image">
              <img src="/placeholder.svg?height=200&width=300" alt="Profile" />
            </div>
            ...
            <div class="preview-info">
              ...
              <div class="preview-detail">
                ...
                <span>jeslito.geverola@dorsu.edu.ph</span>
              </div>
              <div class="preview-detail">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="preview-department">FACET</div>
            </div>

            <button class="btn-edit-large">Edit</button>
          </div>
        </div>
      </div>
    </main>
