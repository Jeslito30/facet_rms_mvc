...
<head>
    ...
    <link rel="stylesheet" href="/facet-rms/public/css/signup.css">
</head>
<body>
        ...
        <div class="form-section">
            ...
            <form id="signupForm" novalidate>
                ...
                <div class="signin-prompt">
                    Already have an account? <a href="/facet-rms/public/user/signin">Sign In</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let currentStep = 1;
            const API_ENDPOINT = '/facet-rms/public/user/signup_api';
            ...
            async function submitForm() {
                ...
                try {
                    ...
                    if (result.success) {
                        ...
                        window.location.href = '/facet-rms/public/user/signin';
                    } else {
